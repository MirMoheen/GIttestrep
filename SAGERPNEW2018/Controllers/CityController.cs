...
namespace SAGERPNEW2018.Controllers
{
    public class CityController : Controller
    {
        ...
        public ActionResult Index()
        {
            try
            {
                CityInformtion a = new CityInformtion();
        ...
        [UserRightFilters]
        public ActionResult create(CityInformtion a)
        {
            try
            {
                a.IsNew = Convert.ToBoolean(TempData["IsNew"]);
        ...
        public ActionResult Edit(string id)
        {
            try
            {
                ...
                obj.IsView = a.IsView;
                obj.CityID = Convert.ToInt32(IDo[0]);
        ...
        public ActionResult Save(CityInformtion model)
        {
            try
            {
                int check;
        ...
        public ActionResult Duplicate(string Name, string ID)
        {
            ...
            {
                string json = "";
                var list = new CityInformtion().checkDuplicate(Convert.ToInt32(ID), Name);
                if (list.Count() > 0)
                {
